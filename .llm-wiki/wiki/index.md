...
| [Публичный API каталога](concepts/public-catalog-filter-api.md) | Фасеты (/api/reference/filter/tire) + листинг (/api/catalog/tires): контракт фильтров, учёт города, агрегация цены, кеш с индексом ключей и JSON-roundtrip (ADR 0004) | 2026-08-19 |
...
| [Кеширование](concepts/caching.md) | Cache Service до Action, Observer-инвалидация, TTL, индекс ключей, JSON-roundtrip сериализация (ADR 0004) | 2026-08-19 |
