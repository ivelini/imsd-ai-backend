...
| [Запись на шиномонтаж: домен Booking](concepts/booking-domain.md) | Перенос из tireslot (ADR 0012): 10 таблиц booking_*, единый клиент users (телефон-first), прайс-куб и комплексы, слот-сетка и SMS-код, settings KV; публичный UI — SPA через /api/booking, админка — кластер Filament (волны 1–4) | 2026-09-11 |
