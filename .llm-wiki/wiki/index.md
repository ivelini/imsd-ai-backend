...
| [Публичный API каталога](concepts/public-catalog-filter-api.md) | Справочник городов (/api/reference/city) + фасеты (/api/reference/filter/tire) + листинг (/api/catalog/tires): контракт фильтров, учёт города, meta.seo, агрегация цены, кеш с индексом ключей и JSON-roundtrip (ADR 0004) | 2026-08-21 |
