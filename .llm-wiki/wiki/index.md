...
| [Админ-панель на Filament](concepts/admin-panel-filament.md) | Решение о переходе с React SPA на Filament; каркас: панель /panel, session-guard admin, FilamentUser (is_active), AdminRoleCode + policies, нативные уведомления; политика слоёв (запись через Actions); PanelAction для DomainException; волны 0–2d: справочники, товары (Tire/Wheel), изображения, импорт, остатки складов, акции и снос их admin API; навигация-кластер «Каталог» + группы поднавигации (привязка через $cluster), topNavigation, снос экранов Cities/Countries | 2026-09-10 |
