...
| [Каталог: ценообразование](concepts/catalog-pricing.md) | Полная цена города: цепочка наценок, MarkupRuleMatcher, применение акций (PromotionMatcher/PromotionDiscount, base_price), пересчёт catalog_prices от готовой stocks.price, округление | 2026-09-10 |
...
| [Импорт каталога из XLSX](concepts/xlsx-import-pipeline.md) | Пайплайн upload → ImportMasterJob → чанки → ChunkJob, маппинг XLSX → БД (description на модель, origin-колонки, евро-лейбл, SEO-формулы name/slug), инвалидация; точка входа — страница панели /panel/import | 2026-09-10 |
