...
| 0014–0017, 0020–0022 | Домен Booking (перенесены из tireslot): сетка слотов планировщиком, запись по коду, часовая сетка, снимок цены, точное совпадение прайса, транзиентные комплексы, без сущности «автомобиль» | Accepted | 2026-09-12 |
| 0018, 0019 | tireslot: Livewire-сайт и шаги записи в URL — заменены API + SPA (0012) | Superseded | 2026-09-12 |
| 0023 | tireslot: Actions/Services — заменено конвенциями backend (execute(DTO)) | Superseded | 2026-09-12 |
