...
| 0014–0017, 0020, 0021 | Домен Booking (перенесены из tireslot): сетка слотов планировщиком, запись по коду, часовая сетка, снимок цены, точное совпадение прайса, транзиентные комплексы, без сущности «автомобиль» | Accepted | 2026-09-12 |
