 ...
 * @property float|null $city_old_price Цена без скидки (transient, ставит GetTireList, только при акции)
 * @property bool $city_promotion Признак действия акции в городе (transient, ставит GetTireList)
 */
