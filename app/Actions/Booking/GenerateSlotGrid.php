...
/**
 * Генерация сетки слотов по шаблону недели (ADR 0001 tireslot).
 *
 ...
 */
final readonly class GenerateSlotGrid
{
    public function execute(): void
    {
        ...
        foreach (range(0, $horizonDays - 1) as $offset) {
            ...
            $weekday = $date->isoWeekday() - 1; // 0 (пн) – 6 (вс), как booking_schedule_templates.weekday
