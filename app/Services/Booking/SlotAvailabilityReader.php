 ...
 *
 * Единый источник правила доступности: слот не закрыт, начало не раньше
 * now + min_lead_time_h (округление вверх до часа), дата в пределах горизонта
 * booking_horizon_days. Подтверждение кода проверит то же правило
...
class SlotAvailabilityReader
{
     ...
     * дня не показываются вовсе, закрытые помечаются (сайт рисует их busy, ФТ-6 tireslot).
     *
